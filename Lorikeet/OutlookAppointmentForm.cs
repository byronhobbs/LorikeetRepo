...
namespace Lorikeet
{
    ...
    public partial class OutlookAppointmentForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        ...
        public OutlookAppointmentForm(SchedulerControl scheduler)
        {
            InitializeComponent();
        ...
        {
            appointment.Subject = Control.DataStorage.Appointments.Labels.GetById(appointment.LabelKey).DisplayName;
            return true;
        }
        ...
        void ExportAppointment(Stream stream)
        {
            ...
            exporter.ProductIdentifier = "-//Lorikeet.";
